...
class PuzzleTwo {
    ...
    public static void main(String[] args) {
        List<String> passwordPolicyList = passwordPolicies();
        int validCount = 0;

        for (String passwordPolicy : passwordPolicyList) {
            int min = getMin(passwordPolicy);
            int max = getMax(passwordPolicy);
            char letter = getLetter(passwordPolicy);
            String password = getPassword(passwordPolicy);

            boolean minFlag = false;
            boolean maxFlag = false;
            if (letter == password.charAt(min - 1)) {
                minFlag = true;
            }

            if (letter == password.charAt(max - 1)) {
                maxFlag = true;
            }
        ...
        System.out.printf("Valid count: %d", validCount);
    }

    private static int getMin(String pass) {
    ...
    private static int getMax(String pass) {
    ...
    private static char getLetter(String pass) {
    ...
    private static List<String> passwordPolicies() {
        return List.of("2-8 t: pncmjxlvckfbtrjh",
            "8-9 l: lzllllldsl",
